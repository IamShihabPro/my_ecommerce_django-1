...
class MyUserManager(BaseUserManager):
    #  A custom manager with deal as unique identifier
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
        gettext_lazy('active'), 
        default=True,
        help_text= gettext_lazy('Designation whether the user should be treated as active. Unselect this instead of deleting accounts')
    )
